      ...
      >
        ...
        <ol className="relative border-l border-gray-200 dark:border-gray-700 mt-2">
          <li className="mb-10 ml-4">
            ...
            <time className="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">Jan 2022 ‑ Apr 2023</time>
            <div>
              <span className="text-base font-semibold text-gray-900 dark:text-white">Software Developer</span>
              <span className="text-[14px] font-medium text-gray-600 dark:text-gray-400">  at</span>
              <span className="text-[14px] font-medium text-gray-600 dark:text-gray-400"> UFAZ</span>
              <span className="text-[14px] font-medium text-gray-600 dark:text-gray-400"> ·</span>
              <span className="text-[14px] font-medium text-gray-600 dark:text-gray-400"> Part-time</span>
            </div>
