...
const JobTimeLine = ({ position, description, startedAt, endedAt, company, workScheduleType }) => {
    return (
        <li className="mb-10 ml-5 lg:ml-[22px] max-w-[70%] md:max-w-full">
            ...
            <motion.time variants={items} className="text-[.83rem] md:text-[.71rem] lg:text-sm font-medium leading-none text-neutral-600 dark:text-neutral-400">{startedAt} ‑ {endedAt ? endedAt : "Present"}</motion.time>
