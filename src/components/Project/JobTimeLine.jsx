    ...
    return (
        <li className="mb-10 ml-5 lg:ml-[22px] max-w-[70%] md:max-w-full">
            ...
            <motion.div variants={items} className='flex items-end gap-1'>
                ...
                <span className="text-[.72rem] lg:text-[.8rem] md:text-[.65rem] text-neutral-600 dark:text-neutral-400 font-medium self-center md:self-end">@</span>
                <span className="text-[.87rem] lg:text-[.92rem] md:text-[.73rem] font-medium dark:text-[#fafafa] text-[#09090B]">{company}</span>
                <span className="text-[.95rem] font-[600] text-neutral-600 dark:text-neutral-400 md:self-end">·</span>
