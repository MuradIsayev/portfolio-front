    ...
    <motion.div
      ...
      <div
        ...
        <div className="txt dark:text-[#fafafa] text-[#09090B]">
          <h1 className='dark:bg-[#09090B] bg-white group-hover:bg-transparent !duration-0 project-name text-[1.18rem] md:text-base font-[300] uppercase text-neutral-600 dark:text-neutral-400 dark:group-hover:text-[#fafafa] group-hover:text-[#09090B]'>{name}</h1>
