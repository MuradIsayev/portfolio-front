  ...
  return (
    <motion.div
      ...
      <div
        ...
        className={`hover:bg-[#f7f7f7ea] dark:bg-[#09090B] hover:dark:bg-[#111113dc] border border-[#E4E4E7] dark:border-[#27272A] group min-h-[160px] md:min-h-[140px] card ${darkColor} ${color}`}>
