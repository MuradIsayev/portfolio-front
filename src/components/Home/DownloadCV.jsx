...
const DownloadCV = () => {
    ...
    return (
        <div className="download-button mt-2 rounded-md">
            <div className="wrapper rounded-md" onClick={() => !isAnimating && animate()}>
                <AnimatePresence>
                    <motion.div
                        className="container download bg-[#dbdbdb] hover:bg-[#cfcfcf] dark:bg-[#F1F1F1] transition ease-linear duration-150"
                    ...
                    <motion.div className="container loadingSpinner dark:bg-[#d1d1d1] bg-sky-700 dark:text-black" animate={loadingControls}>
                        <div role="status">
                            <svg aria-hidden="true" class="inline w-[1.2rem] h-[1.2rem] text-sky-700 dark:text-[#d1d1d1] fill-white animate-spin dark:fill-black" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <motion.div className="container done dark:bg-[#919191] dark:text-black bg-sky-900 text-white" animate={doneControls}>
