        ...
        <div key={`${message.userName}-${message.createdAt}`} className="mt-2">
          <div className="flex flex-row justify-start items-center gap-[4px]
            ...
            <div className="flex w-[85%] gap-[.2rem]">
              <span className="text-[.95rem] md:text-[.65rem] max-w-[20%] md:max-w-[35%] font-[400] md:whitespace-nowrap dark:text-[#e7e6e6e8] text-[#09090bdc] ">{message?.userName}:</span>
              <span className="text-[.95rem] md:text-[.65rem] w-[85%] md:w-[75%] font-[400] break-words text-[#18181B] dark:text-[#ececec]">{message?.message}</span>
            </div>
          </div>
        </div>
      ))
