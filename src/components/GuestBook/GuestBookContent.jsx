        ...
        <div className="mt-2">
          {userData?.messages.map((message) => (
            <div className="flex flex-row justify-start items-center gap-[3px] 
              ...
              <img
                src={userData?.photoURL} alt="Profile photo" className="rounded-full w-7 border border-gray-300 mr-1 transition ease-in-out duration-100 blur-[.8px] hover:blur-0" />
