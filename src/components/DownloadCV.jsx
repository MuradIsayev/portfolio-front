...
const DownloadCV = () => {
    ...
    return (
        <div className="grid mt-3 rounded-md download-button">
            <div className="wrapper rounded-md h-[3.5rem] w-[10rem] md:h-[2.5rem]
                             md:w-[6.7rem] overflow-hidden cursor-pointer relative" onClick={() => !isAnimating && animate()}>
                <AnimatePresence>
                    <motion.div
                    ...
                    >
                        <motion.div
                            ...
                            transition={{
                                ...
                                ease: 'easeInOut',
                                delay: 2
                            }}><FaAngleDoubleDown className="md:w-[9px] md:h-[9px] h-[14px] w-[14px] icon dark:text-neutral-400 text-neutral-600" /></motion.div>
                        <div className='dark:text-neutral-400 text-neutral-600 text-[.97rem] md:text-[.67rem]'>CV</div>
                    </motion.div>
                    <motion.div className="home-download-buttons md:text-[.7rem] z-[2] top-[-100%] 
                        ...
                        <div role="status">
                            <svg aria-hidden="true" className="inline w-[1.2rem] h-[1.2rem] md:w-[.9rem] md:h-[.9rem] text-neutral-600 dark:text-neutral-500 fill-[#fafafa] animate-spin dark:fill-[#09090B]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className='text-[#fafafa] dark:text-[#09090B] text-[.97rem] md:text-[.67rem]'>Loading...</div>
                    ...
                    dark:bg-neutral-400 dark:text-black bg-neutral-700 text-white"
                        ...
                        <div className='text-[.97rem] md:text-[.67rem]'>DONE</div>
                    </motion.div>
                </AnimatePresence>
            </div>
        </div >
