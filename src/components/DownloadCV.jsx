            ...
            <div className="wrapper rounded-md h-[3.5rem] w-[9rem] md:h-[2.5rem]
                ...
                <AnimatePresence>
                    ...
                    <motion.div className="home-download-buttons md:text-[.7rem] z-[2] top-[-100%] 
                        ...
                        <div role="status">
                            <svg aria-hidden="true" className="inline w-[1.2rem] h-[1.2rem] md:w-[.9rem] md:h-[.9rem] text-neutral-800 dark:text-[#d1d1d1] fill-[#fafafa] animate-spin dark:fill-[#09090B]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
